        ...
        internal static void Initialize(ApplicationDbContext context) //(rename ApplicationDbContext for MySQL)
        {
            ...
            var hotproducts = new Product[]
            {
                    ...
                    new Product
                {
                    ...
                    new Product
                {
                    Name="Camera CANON IXIS190",
                    Amount= 30,
                    Description="Độ phân giải 20.1MP, CCD, Ống kính ZEISS với zoom quang học 8x, Quay phim độ phân giải cao HD 720p, Optical SteadyShot (chế độ Active) *1 ",
                    Price= 40000000,
                    ImageUrl="/img/ixus-190.jpg",
                    Discount=0.1f,
                    ProductType= Common.Enum.ProductType.Camera,
                    Trend= Common.Enum.Trend.NewProduct,
                    CreatedAt= DateTime.UtcNow,
                    ...
                    new Product
                {
                    Name="Camera SONY CYPER",
                    Amount= 30,
                    Description="Cảm biến CCD 20 megapixel,Bộ xử lý hình ảnh Digic 4+",
                    Price= 29000000,
                    ImageUrl="/img/sony-cyber.jpg",
                    Discount=0.3f,
                    ProductType= Common.Enum.ProductType.Camera,
                    Trend= Common.Enum.Trend.NormalProduct,
                    CreatedAt= DateTime.UtcNow,
                    Rating=4,
                },
                    new Product
                {
                    Name="Camera DIGITAL ZOOM",
                    Amount= 30,
                    Description="Cảm biến hình ảnh: cảm biến CMO, Màn hình hiển thị: màn hình LCD 2.7 inch (16:9),Định dạng Tập Tin: JPEG (Ảnh tĩnh)/AVI (Video) ",
                    Price= 770000,
                    ImageUrl="/img/digital-zoom.jpg",
                    Discount=0.2f,
                    ProductType= Common.Enum.ProductType.Camera,
                    Trend= Common.Enum.Trend.NormalProduct,
                    CreatedAt= DateTime.UtcNow,
                    ...
                    new Product
                {
                    Name="Camera FUJIFILM A3",
                    Amount= 30,
                    Description="Cảm biến CMOS kích thước APS-C, Độ phân giải 24.2MP, Chip xử lý ảnh EXR Processor II",
                    Price= 12000000,
                    ImageUrl="/img/fujifilm-a3.jpg",
                    Discount=0.3f,
                    ProductType= Common.Enum.ProductType.Camera,
                    Trend= Common.Enum.Trend.NewProduct,
                    CreatedAt= DateTime.UtcNow,
                    ...
                    new Product
                {
                    Name="Camera SONY A7",
                    Amount= 30,
                    Description="Cảm biến APS-C CMOS 24.3 Megapixels, Bộ xử lý hình ảnh BIONZ X, Chống rung 5 trục; ổn định hình ảnh",
                    Price= 34000000,
                    ImageUrl="/img/sony-a7.jpg",
                    Discount=0.0f,
                    ProductType= Common.Enum.ProductType.Camera,
                    Trend= Common.Enum.Trend.NewProduct,
                    CreatedAt= DateTime.UtcNow,
